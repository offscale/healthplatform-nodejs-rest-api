...
export declare const register_all: (auth_sdk: AuthTestSDK, mocks: User[]) => Promise<User[]>;
export declare const tearDownConnections: (orms_out_or_done: IOrmsOut | Done, done?: Done | undefined) => any;
export declare const closeApp: (app: Server) => (done: Done) => any;
export declare const testObjectValidation: (common_test_obj: {
